...
<div id="footer-wrapper">
        ...
        <?php } ?>
         <div class="copyright-wrapper">
        	<div class="container">
           		 <div class="copyright-txt"><?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','fundraiser-lite');?>  <a href="<?php echo esc_url('https://www.sktthemes.org/product-category/non-profit-wordpress-themes/');?>" target="_blank"><?php esc_html_e('SKT Non Profit Themes','fundraiser-lite'); ?></a></div>
            	 <div class="design-by">
