...
define('FUNDRAISER_LITE_SKTTHEMES_URL','https://www.sktthemes.org');
define('FUNDRAISER_LITE_SKTTHEMES_PRO_THEME_URL','https://www.sktthemes.org/shop/fundraising-wordpress-theme/');
define('FUNDRAISER_LITE_SKTTHEMES_FREE_THEME_URL','https://www.sktthemes.org/shop/free-ngo-wordpress-theme/');
define('FUNDRAISER_LITE_SKTTHEMES_THEME_DOC','http://sktthemesdemo.net/documentation/fundraiser-documentation/');
define('FUNDRAISER_LITE_SKTTHEMES_LIVE_DEMO','https://www.sktperfectdemo.com/demos/fundraiser/');
define('FUNDRAISER_LITE_SKTTHEMES_THEMES','https://www.sktthemes.org/themes/');
/**
...
add_action( 'tgmpa_register', 'fundraiser_lite_register_required_plugins' );
 
function fundraiser_lite_register_required_plugins() {
	$plugins = array(
		array(
			'name'      => 'SKT Templates',
			'slug'      => 'skt-templates',
