...
<div class="wrapper-info">
	...
	<div class="col-right">			
			<div class="centerbold">
				<hr />
				<a href="<?php echo esc_url(FUNDRAISER_LITE_SKTTHEMES_LIVE_DEMO); ?>" target="_blank"><?php esc_html_e('Live Demo', 'fundraiser-lite'); ?></a> | 
				<a href="<?php echo esc_url(FUNDRAISER_LITE_SKTTHEMES_PRO_THEME_URL); ?>"><?php esc_html_e('Buy Pro', 'fundraiser-lite'); ?></a> | 
				<a href="<?php echo esc_url(FUNDRAISER_LITE_SKTTHEMES_THEME_DOC); ?>" target="_blank"><?php esc_html_e('Documentation', 'fundraiser-lite'); ?></a>
